...
fa_img_dir = r'./Data/dault_image'
save_img_dir = r'./Data/dault_image_crop'
...
for son_img_dir in os.listdir(fa_img_dir):
     ...
     for img_name in os.listdir(fa_img_dir + '/' + son_img_dir):
         ...
         crop_left_data = left_data[100:, : w//2, :]
         center_right_x, center_right_y = w//2, h//2
         crop_right_data = right_data[100:, : w//2, :]

         # (crop_left_data.shape, crop_right_data.shape)
         crop_left_data = cv2.resize(crop_left_data, (256, 256))
         crop_right_data = cv2.resize(crop_right_data, (256, 256))
