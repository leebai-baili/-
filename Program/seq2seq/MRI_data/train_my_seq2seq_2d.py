...
from mydata import MyDataset, get_train_transforms, get_valid_transforms
from seq2seq import Generator


def train(args, net, device):
    data_path = r'./Data/dault_image_npy'
    ...
    for epoch in range(epochs):
        ...
        for batch in tqdm(train_loader, total=len(train_loader)):
            ...
            source_img = source_seq.to(device)
            target_img = target_seq.to(device)
...
def get_args():
    ...
    parser.add_argument('-c', '--config', dest='config', type=str, default='/home/gem/GuanH/Program/seq2seq/config_examples/my_data.yaml',
                        help='config file')
