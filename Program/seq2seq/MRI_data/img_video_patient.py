...
with open('/home/gem/GuanH/program_seq2seq_Y/seq2seq/config_examples/my_data.yaml', 'r') as f:
...
data_path = r'/home/gem/GuanH/Data/dault/Benign/0413_0017'
...
for t in range(len(data_list)):
    ...
    for i in range(output_target.shape[0]):
        ...
        cv2.imwrite('result_images/0413_0017/pred/' + str(num_id).rjust(5, '0') + '.jpg', predict)
    ...
    for i in range(target_img.shape[0]):
        ...
        cv2.imwrite('result_images/0413_0017/gt/gt_' + str(num_id).rjust(5, '0') + '.jpg', gt)
    ...
    for i in range(source_img.shape[0]):
        ...
        cv2.imwrite('result_images/0413_0017/sr/sr_' + str(num_id).rjust(5, '0') + '.jpg', sr)

    num_id += 1


videoPath_sr = "result_images/0413_0017/sr.mp4"
imgPath_sr = 'result_images/0413_0017/sr/'
Pic2Video(imgPath_sr, videoPath_sr)

videoPath_pred = "result_images/0413_0017/pred.mp4"
imgPath_pred = 'result_images/0413_0017/pred/'
Pic2Video(imgPath_pred, videoPath_pred)

videoPath_gt = "result_images/0413_0017/gt.mp4"
imgPath_gt = 'result_images/0413_0017/gt/'
